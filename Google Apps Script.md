...
function jsonExFile() {
  ...
  var json = jsonFromUrl("https://json.org/example.html");
...
var obj_ofu = objFromUrl("https://json.org/example.html");
...
Logger.log(JSON.stringify(objFromUrlOrFile("https://json.org/example.html")));
